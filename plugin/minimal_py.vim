...
nnoremap <silent> <Plug>GoToDebugLine :call minpy#GoToDebugLine()<cr>
nnoremap <silent> <Plug>OpenPyDebugFile :call minpy#OpenDebugFile()<cr>
" nnoremap <silent> <unique> <Plug>OpenPyDebugFile :call minpy#OpenDebugFile()<cr>
...
nnoremap <silent> <Plug>DelBreakPoints minpy#DelBreakPoints()
